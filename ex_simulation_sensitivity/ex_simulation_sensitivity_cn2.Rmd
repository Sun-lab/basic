...
We first load the simulated data with copy number alterations, and then add noise into the copy number data. Here we randomly take 20% of loci and randomly assign their copy numbers. 
```{r load_data_cna}
...
table(b.cn)
set.seed(999)
w2pertrub = sample(length(b.cn), size = round(0.2*length(b.cn)))
